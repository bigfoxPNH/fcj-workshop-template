...
![VPC List](/images/5-Workshop/5.3-Implementation%20Steps/vpc-list.png?classes=shadow)
...
![Subnet List](/images/5-Workshop/5.3-Implementation%20Steps/subnet-list.png?classes=shadow)
...
![Lambda Source Code Configuration](/images/5-Workshop/5.3-Implementation%20Steps/lambda-source.png?classes=shadow)
...
![Lambda VPC Configuration](/images/5-Workshop/5.3-Implementation%20Steps/lambda-vpc.png?classes=shadow)
...
![IAM Role Assignment](/images/5-Workshop/5.3-Implementation%20Steps/iam-role.png?classes=shadow)
...
![S3 Files Management](/images/5-Workshop/5.3-Implementation%20Steps/s3-files.png?classes=shadow)
...
![CloudWatch Log Groups Management](/images/5-Workshop/5.3-Implementation%20Steps/cloudwatch-logs.png?classes=shadow)
