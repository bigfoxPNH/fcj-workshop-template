...
### [Event 1](4.1-Event1/)
&emsp;**Tên sự kiện:** Chia sẻ kiến thức về phương pháp học tập, prompting và giao tiếp hiệu quả với AI, AI-Ready Fresher, và Phương pháp BMAD
...
### [Event 2](4.2-Event2/)
&emsp;**Tên sự kiện:** Context is Everything, CloudFront as Your Foundation, 36-hours với LotusHack, Hệ thống Multi-Agent cấp doanh nghiệp
...
### [Event 3](4.3-Event3/)
&emsp;**Tên sự kiện:** Trao đổi câu hỏi ôn thi Chứng chỉ AWS
...
### [Event 4](4.4-Event4/)
&emsp;**Tên sự kiện:** Ngày hội Cộng đồng FCAJ - Tháng 6 năm 2026
