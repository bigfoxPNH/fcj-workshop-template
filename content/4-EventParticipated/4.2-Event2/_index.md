...
<div style="display: flex; gap: 10px; justify-content: center; flex-wrap: wrap;">
  <img src="/images/4-EventParticipated/event2.png" alt="Event 2 Photo 1" style="width: 30%; min-width: 200px; max-width: 300px; height: auto; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);" />
  <img src="/images/4-EventParticipated/event2.1.png" alt="Event 2 Photo 2" style="width: 30%; min-width: 200px; max-width: 300px; height: auto; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);" />
  <img src="/images/4-EventParticipated/event2.2.png" alt="Event 2 Photo 3" style="width: 30%; min-width: 200px; max-width: 300px; height: auto; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);" />
</div>
